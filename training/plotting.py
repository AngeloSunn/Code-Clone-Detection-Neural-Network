...
def plot_metrics(trainer, output_dir: str = "logs"):
    ...
    _save_plot(eval_steps, eval_precision, "Precision", "Eval Step", "Precision", "plot_precision.png")
    _save_plot(eval_steps, eval_recall, "Recall", "Eval Step", "Recall", "plot_recall.png")
